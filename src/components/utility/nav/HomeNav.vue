<template>
    <v-app-bar app light
        class="nav px-2 elevation-0 border-bottoms flex w-screen justify-between items-center bg-white ">
        <div class="nav-wrap w-screen flex sm:justify-evenly items-center md:justify-evenly lg:justify-evenly">
